      ...
      <Card>
        <CardHeader class="pb-2">
          <div class="flex items-center gap-2">
            ...
            <CardTitle>{{ todayTraining.title }}</CardTitle>
            <Badge variant="outline">{{ todayTraining.duration }}</Badge>
          </div>
        </CardHeader>
        <CardContent class="grid gap-4">
          <div class="space-y-2">
            <div class="flex items-center justify-between text-sm">
              ...
              <span class="font-medium">{{ todayTraining.progress }}%</span>
            </div>
            <div class="h-2 w-full rounded-full bg-secondary">
              <div
                class="h-2 rounded-full bg-primary transition-all"
                :style="{ width: `${todayTraining.progress}%` }"
              />
            </div>
          </div>
          <Button class="w-full">
